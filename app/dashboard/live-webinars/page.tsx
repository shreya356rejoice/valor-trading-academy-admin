...
console.log("hello----",formData.get("courseStart")?.toString());
  ...
  async function handleCourseSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Validate form
      const errors = validateForm(formData, "live");
    ...
    <div>
      ...
      >
        <DialogContent className="max-w-2xl gap-0">
          <DialogHeader>
            <DialogTitleUI>{editCourse ? `Edit Live Webinars` : "Create Live Webinars"}</DialogTitleUI>
          </DialogHeader>
            ...
            <form className="space-y-4 h-[54vh] overflow-y-auto px-1 scroll-thin" onSubmit={handleCourseSubmit}>
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1">
                  <label className="block font-medium mb-1">Live Webinar Date</label>
                  <Popover>
